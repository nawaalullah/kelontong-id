...
@section('content')
    ...
    <form action="{{ route('kategori.index') }}" method="GET" class="flex items-center gap-3 mb-4">
        ...
        @if ($search)
            <a href="{{ route('kategori.index') }}" class="text-xs text-ink-400 hover:text-clay-600 underline">Reset</a>
        @endif
    </form>
